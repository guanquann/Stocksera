...
def interest_rate():
    ...
    url = "https://fred.stlouisfed.org/graph/fredgraph.csv?bgcolor=%23e1e9f0&chart_type=line&drp=0&fo=open%20" \
          ...
          "left&cosd=1954-07-01&coed=2023-03-01&line_color=%234572a7&link_values=false&line_style=solid&mark_type=" \
          "none&mw=3&lw=2&ost=-99999&oet=99999&mma=0&fml=a&fq=Monthly&fam=avg&fgst=lin&fgsnd=2020-02-01&" \
          f"line_index=1&transformation=lin&vintage_date={current_date_time}&revision_date={current_date_time}" \
          f"&nd=1954-07-01"
    df = pd.read_csv(url)
