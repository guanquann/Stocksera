...
function show_ticker_table(information) {
  ...
  if (quoteType == "ETF") {
    ...
    var outstanding_shares = information["sharesOutstanding"].toLocaleString();
    var floating_shares = information["floatShares"].toLocaleString();
    ...
    var dividend_yield = information["trailingAnnualDividendYield"]
      ...
      : "N/A";
    var dividend_amount = information["trailingAnnualDividendRate"]
      ? information["trailingAnnualDividendRate"]
      : "N/A";
    var employees = information["fullTimeEmployees"].toLocaleString();
  ...
  table_code = `
        <table>
            ...
            <tr>
                <td>Volume: ${information["regularMarketVolume"].toLocaleString()}</td>
                <td>10D Avg Vol: ${information["averageDailyVolume10Day"].toLocaleString()}</td>
            </tr>
            <tr>
