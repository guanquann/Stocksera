...
urlpatterns = [
    ...
    path(
        "stocksera_trending/", views.stocksera_trending, name="api_stocksera_trending"
    ),
    path(
        "stocks/sec_fillings/<str:ticker_selected>/",
        views.sec_fillings,
        name="api_sec_fillings",
    ),
    path(
        "stocks/news_sentiment/<str:ticker_selected>/",
    ...
    path(
        "stocks/top_short_volume/", views.top_short_volume, name="api_top_short_volume"
    ),
    path(
        "stocks/short_volume/<str:ticker_selected>/",
        views.short_volume,
        name="api_short_volume",
    ),
    path(
        "stocks/top_failure_to_deliver/",
        views.top_failure_to_deliver,
        name="api_top_failure_to_deliver",
    ),
    path(
        "stocks/failure_to_deliver/<str:ticker_selected>/",
        views.failure_to_deliver,
        name="api_failure_to_deliver",
    ),
    path("stocks/regsho/", views.regsho, name="api_regsho"),
    path("stocks/regsho/<str:ticker_selected>/", views.regsho, name="api_regsho"),
    path(
        "stocks/top_borrowed_shares/",
        views.top_borrowed_shares,
        name="api_top_borrowed_shares",
    ),
    path(
        "stocks/borrowed_shares/<str:ticker_selected>/",
        views.borrowed_shares,
        name="api_borrowed_shares",
    ),
    path(
        "news/earnings_calendar/", views.earnings_calendar, name="api_earnings_calendar"
    ),
    ...
    path(
        "reddit/subreddit_count/<str:ticker_selected>/",
        views.subreddit_count,
        name="api_subreddit_count",
    ),
    ...
    path(
        "reddit/<str:subreddit>/<str:ticker_selected>/",
        views.reddit_mentions,
        name="api_reddit_mentions",
    ),
    ...
    path(
        "economy/inflation/<str:area>/", views.us_world_inflation, name="api_inflation"
    ),
    ...
    path(
        "economy/initial_jobless_claims/",
        views.initial_jobless_claims,
        name="api_initial_jobless_claims",
    ),
    path(
        "discover/latest_insider_summary/",
        views.latest_insider_summary,
        name="api_latest_insider_summary",
    ),
    ...
    path(
        "discover/largest_companies/",
        views.largest_companies,
        name="api_largest_companies",
    ),
    ...
    path(
        "discover/dividend_history/",
        views.dividend_history,
        name="api_dividend_history",
    ),
