...
def database():
    ...
    cur.execute(
        "CREATE TABLE IF NOT EXISTS stocksera_trending ("
        "ticker VARCHAR(10), "
        "name VARCHAR(300), "
        "count INTEGER, "
        "UNIQUE(ticker))"
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS wsb_trending_24H ("
        "ticker VARCHAR(10), "
        "mentions INTEGER, "
        "sentiment FLOAT, "
        "calls INTEGER, "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS wsb_trending_hourly ("
        "ticker VARCHAR(10), "
        "mentions INTEGER, "
        "sentiment FLOAT, "
        "calls INTEGER, "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS wsb_discussions ("
        "ticker VARCHAR(10), "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS wsb_yf ("
        "ticker VARCHAR(10), "
        "mkt_cap VARCHAR(30), "
        "price_change FLOAT, "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS crypto_trending_24H ("
        "ticker VARCHAR(10), "
        "mentions INTEGER, "
        "sentiment FLOAT, "
        "date_updated VARCHAR(20), "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS crypto_trending_hourly ("
        "ticker VARCHAR(10), "
        "mentions INTEGER, "
        "sentiment FLOAT, "
        "date_updated VARCHAR(20), "
    ...
    for i in ["wsb", "crypto"]:
        ...
        cur.execute(
            "CREATE table IF NOT EXISTS {}_word_cloud ("
            "word VARCHAR(100), "
            "mentions INTEGER, "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS wsb_etf ("
        "ticker VARCHAR(10), "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS subreddit_count ("
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS twitter_trending ("
        "ticker VARCHAR(10), "
        "tweet_count INTEGER, "
        "updated_date VARCHAR(20),"
        "UNIQUE(ticker, updated_date) )"
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS low_float ("
        "ticker VARCHAR(10), "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS usa_inflation ("
        "Year VARCHAR(10), "
        "Jan FLOAT, "
        "Feb FLOAT, "
        "Mar FLOAT, "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS world_inflation ("
        "Country VARCHAR(100), "
        "Last FLOAT, "
        "Previous FLOAT, "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS highest_short_volume ("
        "`Rank` VARCHAR(20), "
        "`Ticker` VARCHAR(10), "
        "`Short Vol` DOUBLE, "
        "`Short Exempt Vol` DOUBLE, "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS top_ftd ("
        "`Date` VARCHAR(20), "
        "`Ticker` VARCHAR(10), "
        "`FTD` VARCHAR(20), "
        "`Price` VARCHAR(20), "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS sec_fillings ("
        "ticker VARCHAR(10), "
        "filling VARCHAR(100), "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS daily_ticker_news ("
        "Ticker VARCHAR(10), "
        "Date VARCHAR(20), "
        "Title VARCHAR(500), "
        "Link VARCHAR(300), "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS latest_insider_trading ("
        "Ticker VARCHAR(10), "
        "Name VARCHAR(200), "
        "Relationship VARCHAR(200), "
        "TransactionDate VARCHAR(20), "
    ...
    cur.execute(
        "CREATE table IF NOT EXISTS latest_insider_trading_analysis ("
        "Ticker VARCHAR(10), "
        "Amount INTEGER, "
        "MktCap INTEGER, "
        "Proportion FLOAT) "
    ...
    cur.execute(
        "CREATE TABLE IF NOT EXISTS shares_available ("
        "ticker VARCHAR(10), "
        "fee  FLOAT, "
        "available INTEGER, "
        "date_updated VARCHAR(20), "
    ...
    cur.execute(
        "CREATE TABLE IF NOT EXISTS highest_shares_available ("
        "ticker VARCHAR(10), "
        "fee  FLOAT, "
        "available INTEGER, "
    ...
    cur.execute(
        "CREATE TABLE IF NOT EXISTS jim_cramer ("
        "`Ticker` VARCHAR(20), "
        "`Direction`  VARCHAR(30), "
        "`Date` VARCHAR(20), "
        "`Return Since` VARCHAR(20) )"
    )
